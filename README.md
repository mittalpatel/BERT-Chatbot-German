...
## Instructions to set up the Bert Chatbot German Demo on Local system

1. Clone the repository in your system.
2. Download the model file from https://drive.google.com/file/d/1p6bWyTdlJNb4mCfHMdwpfcsYI5Aty5OI/view?usp=sharing and unzip it in root directory.
